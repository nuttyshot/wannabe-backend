...
public class OAuth2MemberFactory {
  ...
  public OAuth2Member create(@NonNull Provider registrationId, @NonNull Map<String, Object> resBody) {
  ...
  private OAuth2Member naver(@NonNull Provider registrationId, @NonNull Map<String, Object> resBody) {
  ...
  private OAuth2Member kakao(@NonNull Provider registrationId, @NonNull Map<String, Object> resBody) {
