...
public class OAuth2MemberFactory {
  ...
  private OAuth2Member naver(@NonNull String registrationId, @NonNull Map<String, Object> resBody) {
  ...
  private OAuth2Member kakao(@NonNull String registrationId, @NonNull Map<String, Object> resBody) {
